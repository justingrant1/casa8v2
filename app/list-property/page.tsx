...
export default function ListPropertyPage() {
  ...
  // Auto-populate phone number when checkbox is checked
  useEffect(() => {
    if (formData.includePhoneNumber && !formData.contactPhoneNumber && profile?.phone) {
      setFormData(prev => ({
        ...prev,
        contactPhoneNumber: profile.phone || ""
      }))
    }
  }, [formData.includePhoneNumber, profile?.phone])
